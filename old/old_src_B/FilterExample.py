...
filteredD = scipy.signal.lfilter(filterNum, filterDenom, signalD)
...
if plotPhaseResponse:
	pylab.figure(4)
	pylab.subplot(311)
	pylab.plot(freq, fftPhaseA)
	pylab.subplot(312)
	pylab.plot(freq, fftPhaseB)
	pylab.subplot(313)
	pylab.plot(freq, fftPhaseC)
